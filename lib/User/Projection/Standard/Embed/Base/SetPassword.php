 ...
 * 'SetPassword' entities please see the skeleton
 * class 'SetPassword'. Modifications to the skeleton
...
/**
 * Serves as the base class to the 'SetPassword' entity skeleton.
 *
 * This class contains definitions for attributes and their options available
 * on 'SetPassword' instances. Modifications to getters and setters
 * as well as new additional helper methods should not be placed in here,
 * but be implemented within the skeleton class 'SetPassword'.
 *
 ...
 */
abstract class SetPassword extends EmbeddedEntity
{
    /**
     * Returns the current value of the 'token' attribute on this
     * 'SetPassword' entity. The 'default_value' option set for
