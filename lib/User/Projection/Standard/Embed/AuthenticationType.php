...
use Hlx\Security\User\Projection\Standard\Embed\Base\AuthenticationType as BaseAuthenticationType;

/**
 *
 * This class reflects the declared structure of the 'Authentication'
 * entity. It contains the metadata necessary to initiate and manage the
 * lifecycle of 'AuthenticationEntity' instances. Most importantly
