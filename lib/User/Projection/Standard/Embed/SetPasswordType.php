...
use Hlx\Security\User\Projection\Standard\Embed\Base\SetPasswordType as BaseSetPasswordType;

/**
 *
 * This class reflects the declared structure of the 'SetPassword'
 * entity. It contains the metadata necessary to initiate and manage the
 * lifecycle of 'SetPasswordEntity' instances. Most importantly
 ...
 */
class SetPasswordType extends BaseSetPasswordType
{
}
